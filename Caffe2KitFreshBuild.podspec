Pod::Spec.new do |s|
    ...
    s.subspec 'CPU' do |ss|
      ...
      ss.xcconfig = {
        'HEADER_SEARCH_PATHS' =>  '$(inherited) "$(PODS_ROOT)/Caffe2Kit/lib/caffe2/install/include/" "$(PODS_ROOT)/Caffe2Kit/lib/caffe2/third_party/eigen/"',
